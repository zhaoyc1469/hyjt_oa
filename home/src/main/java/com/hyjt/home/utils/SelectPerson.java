...
/**
 * @author 赵宇驰
 * @time 2017/7/18  22:00
 * @desc ${TODO}
 */

public class SelectPerson implements View.OnTouchListener {
    private Context mContext;
    private TextView tvSelect;
    private String title;
    private String[] items;

    public SelectPerson(Context mContext, TextView tvSelect, String title, String[] items, boolean seled) {
