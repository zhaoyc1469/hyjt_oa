 ...
 * @author 王
 */
public class SelStaffItem implements View.OnTouchListener {
    private Context mContext;
    private TextView tvSelect;
    private String title;
    private List<String> items;

    public SelStaffItem(Context mContext, TextView tvSelect, String title, List<String> items, boolean seled) {
