...
@ActivityScope
public class WaitSolveListPresenter extends BasePresenter<WaitSolveListContract.Model, WaitSolveListContract.View> {
    ...
    @Inject
    public WaitSolveListPresenter(WaitSolveListContract.Model model, WaitSolveListContract.View rootView
    ...
    public void requestMeetingList(final boolean pullToRefresh
        ...
        mModel.getWSolveList(lastMeetingId, 10, CM_Num, CM_name, CM_promoter)
