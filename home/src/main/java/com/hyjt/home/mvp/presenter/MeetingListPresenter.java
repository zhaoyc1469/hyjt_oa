...
public class MeetingListPresenter extends BasePresenter<MeetingListContract.Model, MeetingListContract.View> {
    ...
    @Inject
    public MeetingListPresenter(MeetingListContract.Model model, MeetingListContract.View rootView
            , RxErrorHandler handler) {
        super(model, rootView);
        this.mErrorHandler = handler;
    }

    public void requestMeetingList(final boolean pullToRefresh, String meetingBloc
        ...
        mModel.getMeetingList(lastMeetingId, 10, meetingBloc, CM_Num, CM_name, CM_promoter)
