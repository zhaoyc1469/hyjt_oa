...
@ActivityScope
public class SuperviseSolveListPresenter extends BasePresenter<SuperviseSolveListContract.Model, SuperviseSolveListContract.View> {
    ...
    @Inject
    public SuperviseSolveListPresenter(SuperviseSolveListContract.Model model, SuperviseSolveListContract.View rootView
    ...
    public void requestMeetingList(final boolean pullToRefresh
        ...
        mModel.getSSolveList(lastMeetingId, 10, CM_Num, CM_name, CM_promoter)
