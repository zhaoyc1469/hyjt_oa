...
public class MeetingEditReqs {
    ...
    public String getSysPersonOld() {
        return SysPersonOld;
    }

    public void setSysPersonOld(String sysPersonOld) {
    ...
    public void setFileUploaderOld(String fileUploaderOld) {
        FileUploaderOld = fileUploaderOld;
    }
