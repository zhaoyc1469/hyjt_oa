...
public class StaffSelPop extends PopupWindow {
    ...
    public StaffSelPop(Activity context, List<Node> deptList, StaffNameIdKey dept, View viewById) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.home_staff_sel, null);
