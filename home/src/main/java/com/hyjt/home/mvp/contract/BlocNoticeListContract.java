...
public interface BlocNoticeListContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends IListView {

        void setAdapter(BlocNoticeAdapter adapter);

        void startLoadMore();

        void endLoadMore(String forbidEdit);
    ...
    interface Model extends IModel {
        ...
        Observable<BaseJson<BlocNoticeListResp>> getBNoticeList(int Page, int Rows);
    }
}