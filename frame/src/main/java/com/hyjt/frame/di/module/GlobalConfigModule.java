package com.hyjt.frame.di.module;
...
import com.hyjt.frame.utils.DataHelper;
import com.hyjt.frame.widget.imageloader.BaseImageLoaderStrategy;
import com.hyjt.frame.widget.imageloader.glide.GlideImageLoaderStrategy;
...
//        return mApiUrl == null ? HttpUrl.parse("http://test.cemtn.cn/") : mApiUrl;
        return mApiUrl == null ? HttpUrl.parse("http://192.168.0.69:8066/") : mApiUrl;
    }
