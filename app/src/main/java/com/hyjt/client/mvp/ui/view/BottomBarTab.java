...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.home_common_FFFFFF));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.home_common_FFFFFF));
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.home_bg_msg_bubble);
        mTvUnreadCount.setWidth(min);
        mTvUnreadCount.setHeight(min);
        mTvUnreadCount.setTextColor(getResources().getColor(R.color.home_common_1277C7));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.home_common_FFFFFF));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.home_common_FFFFFF));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.home_common_FFFFFF));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.home_common_FFFFFF));
        }
