...
public class FinancePlPop extends PopupWindow {
    ...
    public FinancePlPop(Context context) {
        super(context);
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.pop_pl_finance, null);

        mPopLayout = (LinearLayout) mMenuView.findViewById(R.id.pop_layout);
        mTvApply = (TextView) mMenuView.findViewById(R.id.tv_apply);
        mTvApprove = (TextView) mMenuView.findViewById(R.id.tv_approve);
//        mTvTeller = (TextView) mMenuView.findViewById(R.id.tv_teller);
        ...
        mTvApprove.setOnClickListener(v -> {
            if (OnClickSelListener != null) {
                OnClickSelListener.onItemClick("2");
            }
        });
//        mTvTeller.setOnClickListener(v -> {
//            if (OnClickSelListener != null) {
