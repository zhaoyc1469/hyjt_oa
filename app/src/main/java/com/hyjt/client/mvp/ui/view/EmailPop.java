...
public class EmailPop extends PopupWindow {
    ...
    private void Init() {
        ...
        mMenuView = inflater.inflate(R.layout.home_email_sel, null);
        ...
        outbox.setOnClickListener(v -> {
            if (OnClickSelListener != null) {
                OnClickSelListener.onItemClick("SendBox");
            }
        });
        inbox.setOnClickListener(v -> {
            if (OnClickSelListener != null) {
                OnClickSelListener.onItemClick("ReceiveBox");
            }
        });
